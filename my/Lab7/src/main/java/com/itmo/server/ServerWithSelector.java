...
public class ServerWithSelector {
    ...
    private Application serverReceiver;
    private boolean serverOn = true;
    private final ByteBuffer b = ByteBuffer.allocate(DEFAULT_BUFFER_SIZE);
    private final int port;
    private static Selector selector;

    public void run(com.itmo.app.Application application) {
    ...
    private void setupNet(){
        ...
        try {
            ...
            System.out.println("Скорее всего, сервер уже запущен с другого окна...");
        }
    }

    public ServerWithSelector(int port, Logger log){
        this.log = log;
        this.port = port;
    }
    ...
    private void initializeCollection(){
        ...
        try {
            ...
            serverReceiver = new Application(drakoniNelegalnie);
        }
    }
